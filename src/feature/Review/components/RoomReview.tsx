				...
				<CardBody>
					<Row className="mt-2">
						<div className="col-md-auto">
							<img
								src="https://ik.imagekit.io/tvlk/apr-asset/dgXfoyh24ryQLRcGq00cIdKHRmotrWLNlvG-TxlcLxGkiDwaUSggleJNPRgIHCX6/hotel/asset/10037566-3c651cb4dc545945950de319383b474b.jpeg?_src=imagekit&tr=h-128,q-40,w-128"
								alt=""
								className="rounded"
							/>
						</div>
						<div className="col-9 p-0">
							<CardTitle
								className="d-flex fw-bold ms-3 mt-2"
								tag="h5"
							>
								<img
							...
							<ul className="row p-0 ms-3 mb-0">
								<li className="col p-0">
									<CardText className="fw-bold text-muted">
										Ngày nhận phòng:
									</CardText>
					...
					<CardText className="d-flex align-items-center border border-primary rounded p-3 bg-primary bg-opacity-10 mt-3">
						<img
							src="https://d1785e74lyxkqq.cloudfront.net/_next/static/v2/f/fc5c0fe9467d347bab8b0f2f9194868b.svg"
							alt=""
							className="pe-3"
						/>
						<small className="fw-bold text-primary">
							Để được nhận phòng sớm hoặc muộn, vui lòng
							thoả thuận trực tiếp với nơi lưu trú.
						</small>
					</CardText>
					...
					<Row>
						...
						>
							<CardTitle className="fw-bold">
								Superior Queen Room with Window
							</CardTitle>
